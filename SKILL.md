        ---
        name: "r00-hesreallyhim-awesome-claude-code--ecommerce"
        description: >
          🛒 E-commerce & Retail skill suite derived from hesreallyhim/awesome-claude-code.
...
- `/marketplace-audit` — Amazon/eBay listing health score, Buy Box eligibility and keyword gap
        ...
        ```bash
        # Install this skill
        cp -r . ~/.claude/skills/r00-hesreallyhim-awesome-claude-code--ecommerce/

        # In Claude Code
        /read ~/.claude/skills/r00-hesreallyhim-awesome-claude-code--ecommerce/SKILL.md
        ```
